...
export const STADIUM_PERMITS: StadiumPermit[] = [
  ...
  { id: "marn", name: "Instrumento ambiental", entity: "MARN", status: "reportado", priority: "alta", whyItMatters: "Define categoria ambiental, mitigaciones y obligaciones de cumplimiento.", missingEvidence: "Resolucion ambiental, instrumento y medidas de mitigacion." },
